...
const TopThreeList = () => {
    ...
    return (
        <GridList cols={3} className={classes.root} style={{ margin: "30px auto" }} spacing={3}>
            <GridListTile style={{ height: "auto" }}><TopThreeItem rank={1} /></GridListTile>
            <GridListTile style={{ height: "auto" }}><TopThreeItem rank={2} /></GridListTile>
            <GridListTile style={{ height: "auto" }}><TopThreeItem rank={3} /></GridListTile>
        </GridList>
    )
}
